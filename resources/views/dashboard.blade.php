        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-200">
                <thead>
                    <tr>
                        <th
                            class="px-6 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-sm font-semibold text-gray-600 uppercase">
                            #</th>
                        <th
                            class="px-6 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-sm font-semibold text-gray-600 uppercase">
                            Nama Properti</th>
                ...
                <tbody>
                    @foreach ($properties as $property)
                        <tr>
                            ...
                            <td class="px-6 py-4 border-b border-gray-200 text-sm">{{ $property->description }}</td>
                            <td>
                                @if ($property->images_url->isNotEmpty())
                                    <img src="{{ Storage::url($property->images_url->first()->image_url) }}"
                                        alt="Foto Properti" style="max-width: 100px; height: auto;">
                                @else
                                    N/A
                                @endif
                            </td>
